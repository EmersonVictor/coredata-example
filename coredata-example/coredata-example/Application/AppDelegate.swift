...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        ...
        containerDescription.shouldMigrateStoreAutomatically = true
        containerDescription.shouldInferMappingModelAutomatically = true
        
        container.persistentStoreDescriptions.append(containerDescription)
